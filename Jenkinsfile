node{
  ...
  stage("publish to s3") {
    s3CopyArtifact buildSelector: lastSuccessful(stable: true), excludeFilter: '/target', filter: '**/target/*.war', flatten: true, optional: true, projectName: 'WarPipeline', target: ''
